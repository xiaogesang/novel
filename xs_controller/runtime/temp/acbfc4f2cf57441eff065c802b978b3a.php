<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\WWW\xs_controller\public/../application/admin\view\novel\update.html";i:1621050265;s:55:"D:\WWW\xs_controller\application\admin\view\layout.html";i:1617248326;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?php echo $data['editor']; ?>" name="editor" data-validate="required:请输入标题"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <select name="types" class="input w50">
                        ...
                        <option value="<?php echo $val['id']; ?>" <?php if($data['types'] == $val['id']): ?> selected <?php endif; ?>><?php echo $val['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div class="tips"></div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?php echo $data['tags']; ?>" name="tags" data-validate="required:请输入标题"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?php echo $data['point']; ?>" name="point" data-validate="required:请输入标题"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <img src="<?php echo $data['cover']; ?>" width="170" alt="">
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field" style="padding-top:8px;">
                    连载中 <input id="ishome" type="radio" value="1" name="novel_status" <?php if($data['novel_status']==1): ?> checked <?php endif; ?>/>
                    已完结 <input id="isvouch" type="radio" value="2" name="novel_status" <?php if($data['novel_status']==2): ?> checked <?php endif; ?>/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <textarea class="input" name="intro" style=" height:90px;"><?php echo $data['intro']; ?></textarea>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
