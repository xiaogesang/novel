<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\WWW\xs_controller\public/../application/admin\view\banner\lists.html";i:1617076277;s:55:"D:\WWW\xs_controller\application\admin\view\layout.html";i:1617248326;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
            <li><a class="button border-main icon-plus-square-o" href="<?php echo url('admin/banner/add'); ?>"> 添加内容</a></li>
        </ul>
    </div>
    <table class="table table-hover text-center">
        ...
        <tr>
            <td style="padding-left:20px;text-align:center;"><?php echo $key+1; ?></td>
            <td width="10%"><img src="<?php echo $val['imgs']; ?>" alt="" width="70" height="50"/></td>
            <td><?php echo $val['title']; ?></td>
            <td>
                <div class="button-group"><a class="button border-main" href="<?php echo url('admin/banner/update',['id'=>$val['id']]); ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red del" data-url="<?php echo url('admin/banner/delete',['id'=>$val['id']]); ?>" href="javascript:void(0)"><span class="icon-trash-o"></span> 删除</a></div>
            </td>
        </tr>
        <?php endforeach; ?>
        <tr>
            <td colspan="8"><?php echo $lists->render(); ?></td>
        </tr>
    </table>
</div>
