<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\WWW\xs_controller\public/../application/admin\view\comment\lists.html";i:1617248847;s:55:"D:\WWW\xs_controller\application\admin\view\layout.html";i:1617248326;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
        ...
        <tr>
            ...
            <td><?php echo $val['novel']; ?></td>
            <td><?php echo $val['user']; ?></td>
            <td><?php echo $val['content']; ?></td>
            <td><?php echo $val['add_time']; ?></td>
            <td><?php if($val['status']==9): ?>待审核<?php elseif($val['status']==1): ?><font color="green">已通过</font><?php else: ?><font color="red">已拒绝</font><?php endif; ?></td>
            <td>
                <div class="button-group">
                    <a class="button border-main change" data-url="<?php echo url('admin/comment/enable',['id'=>$val['id']]); ?>" href="javascript:void(0)">审核通过</a>
                    <a class="button border-red change" data-url="<?php echo url('admin/comment/disable',['id'=>$val['id']]); ?>" href="javascript:void(0)">拒绝通过</a>
                </div>
            </td>
        </tr>
        <?php endforeach; ?>
