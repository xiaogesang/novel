<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\WWW\xs_controller\public/../application/admin\view\novel\types.html";i:1617246636;s:55:"D:\WWW\xs_controller\application\admin\view\layout.html";i:1617248326;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
            <li><a class="button border-main icon-plus-square-o" href="<?php echo url('admin/novel/addtype'); ?>"> 添加分类</a></li>
        </ul>
    </div>
    <table class="table table-hover text-center">
        ...
        <tr>
            <td style="text-align:left; padding-left:20px;"><?php echo $key+1; ?></td>
            <td><?php echo $val['name']; ?></td>
            <td><?php if($val['status']>1): ?>禁用<?php else: ?>启用<?php endif; ?></td>
            <td>
                <div class="button-group">
                    <a class="button border-main" href="<?php echo url('admin/novel/updatetype',['id'=>$val['id']]); ?>"><span class="icon-edit"></span> 修改</a>
                    <a class="button border-red sable" data-url="<?php echo url('admin/novel/sable',['id'=>$val['id']]); ?>" href="javascript:void(0)" ><span class="icon-trash-o"></span> <?php if($val['status']>1): ?>启用<?php else: ?>禁用<?php endif; ?></a>
                    <a class="button border-red del" href="javascript:void(0)" data-url="<?php echo url('admin/novel/deletetype',['id'=>$val['id']]); ?>" ><span class="icon-trash-o"></span> 删除</a></div>
            </td>
        </tr>
        <?php endforeach; ?>
        <tr>
